...
enum parameters {constante_e,constante_a,constante_f}; // se realizo el cambio de los parametros por las 3 constantes e,a y f
...
class mesh{
        float parameters[3]; //Cantidad de paratros pasados a mesh
        int sizes[4];
        node *node_list;
    ...
    public:
        void setParameters(float e,float a,float f){ //los parametros dejan de ser 2 por que ahora tenemos 3 constantes
